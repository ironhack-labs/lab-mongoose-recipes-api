...
//Express configuration to handle request bodies brought by
...
app.post("/recipes", (req, res)=>{
    ...
    }).catch((error)=>{res.status(500).json({message: "Error Recipe"})})
})
...
app.get("/recipes", (req, res)=>{
    ...
    }).catch((error)=>{res.status(500).json({message: "Error Recipes getting"})
    })
})
...
app.get("/recipes/:id", (req, res)=>{
    ...
    }).catch((error)=>{res.status(500).json({message: "error Recipe Id"})})
})
