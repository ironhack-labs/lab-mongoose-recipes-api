...
app.get("/recipes/:id"), async (req, res, next) => {
    try {
        ...
        res.status(500).json({message: "Error while getting a new recipe"})
    }
}
...
app.put("/recipes/:id"), async (req, res, next) => {
    try {
        ...
        res.status(500).json({message: "Error while updating a new recipe"})
...
app.delete("/recipes/:id"), async (req, res, next) => {
    try {
        ...
        res.status(500).json({message: "Error while deleting a new recipe"})
    }
}
