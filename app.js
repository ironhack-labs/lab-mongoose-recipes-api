...
app.post('/recipes', (req, res) => {
    ...
    .catch(e => res.status(500).json({message: "Error when creating new recipe"}))
})
...
app.put('/recipes/:id', (req, res) => {
    ...
    .catch(e => res.status(500).json({message: "Error when trying to update the recipe"}))
})
...
app.delete('/recipes/:id', (req, res) => {
    ...
    .catch(e => res.status(500).json({message: "Error when deleting a recipe"}))
})
